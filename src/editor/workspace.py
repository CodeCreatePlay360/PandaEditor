...
from panda3d.core import MouseWatcher, NodePath, Camera, OrthographicLens, PGTop
from editor.core import EditorCamera
from editor.globals import editor


class EditorWorkspace:
    def __init__(self, showbase, viewport):
    ...
    def clear_ed_aspect_2d(self):
        for np in self.showbase.aspect2d.getChildren():
    ...
    def setup_editor_window(self):
        ...
        self.dr = self.showbase.cam.node().getDisplayRegion(0)
        self.dr.setClearColorActive(False)
        self.dr.setClearColor(self.showbase.getBackgroundColor())
        self.dr.setActive(False)
        self.dr.setSort(0)

        # clear existing / default 2d display regions
        self.dr2d = self.showbase.cam2d.node().getDisplayRegion(0)
        ...
        self.edDr2d = self.showbase.win.makeDisplayRegion(0, 1, 0, 1)
        self.edDr2d.setSort(1)
        self.edDr2d.setActive(True)

        # create a 2d mouse watcher
        self.ed_mouse_watcher_node_2d = MouseWatcher()
        self.showbase.mouseWatcher.get_parent().attachNewNode(self.ed_mouse_watcher_node_2d)
        ...
        self.showbase.render.reparentTo(self.edRender)
        ...
        self.ed_mouse_watcher_node = MouseWatcher()
        self.showbase.mouseWatcher.get_parent().attachNewNode(self.ed_mouse_watcher_node)
    ...
    def update_aspect_ratio(self):
        aspect_ratio = self.showbase.getAspectRatio(self.main_win)
